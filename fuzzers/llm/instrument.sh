...
# Andrew TODO: In order to SKIP_STATIC_ANALYSIS and REUSE_PREBUILT_BC, 
# You need to copy the whole 'fuzzers/aflgo_mazerunner/pre-built/${target_project}' from host to docker '/magma/targets/libxml2/BBtargets/'
